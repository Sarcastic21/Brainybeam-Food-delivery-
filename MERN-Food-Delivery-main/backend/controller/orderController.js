...
const placeOrder = async (req,res) => {
   ...
   /*  const paymentIntent = await stripe.paymentIntents.create({
      amount: req.body.amount * 100, // Amount in smallest currency unit (e.g., cents)
      currency: 'inr', // or 'inr' for Indian currency
      description: 'Software development services', // Adjust as needed
      customer: customer.id, // Link the customer
    });*/
